...
namespace glm
{
	...
	typedef vec<1, ui32, lowp>		lowp_u32vec1;
	typedef vec<2, ui32, lowp>		lowp_u32vec2;
	typedef vec<3, ui32, lowp>		lowp_u32vec3;
	typedef vec<4, ui32, lowp>		lowp_u32vec4;

	typedef vec<1, ui32, mediump>	mediump_u32vec1;
	typedef vec<2, ui32, mediump>	mediump_u32vec2;
	typedef vec<3, ui32, mediump>	mediump_u32vec3;
	typedef vec<4, ui32, mediump>	mediump_u32vec4;

	typedef vec<1, ui32, highp>		highp_u32vec1;
	typedef vec<2, ui32, highp>		highp_u32vec2;
	typedef vec<3, ui32, highp>		highp_u32vec3;
	typedef vec<4, ui32, highp>		highp_u32vec4;

	typedef vec<1, ui32, defaultp>	u32vec1;
	typedef vec<2, ui32, defaultp>	u32vec2;
	typedef vec<3, ui32, defaultp>	u32vec3;
	typedef vec<4, ui32, defaultp>	u32vec4;
