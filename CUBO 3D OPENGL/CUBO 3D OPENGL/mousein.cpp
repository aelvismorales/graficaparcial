...
i32 main() {
	...
	/*glfwSetCursorPosCallback(window, mouse_Callback);*/ // lo podemos mandar a la clase glutiInit
	
	Shader* shader = new Shader();

	ui32 xblocks = 20, yblocks = 20, comps = 6; // comps es los elementos adicionales complementos
